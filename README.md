Distributed-Disk-Registry
gRPC + TCP Hybrid Distributed Server
Bu proje, birden fazla sunucunun dağıtık bir küme (family) oluşturduğu,
kendi aralarında gRPC + Protobuf ile haberleştiği ve lider üye (cluster gateway) üzerinden dış dünyadan gelen TCP text komutlarını işlediği hibrit bir mimari örneğidir.
